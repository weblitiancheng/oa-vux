  ...
  <div>
    ...
    <div>
      <group>
        ...
        <component v-for="(comp,index) in comps" :is="comp.compName" :key="index" :title="comp.title"
          :is-type="comp.isType" :options="comp.options" :text-align="comp.textAlign" :direction="comp.direction"
          :label-position="comp.labelPosition" :value="comp.value"></component>
      </group>
